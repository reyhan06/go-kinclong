                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Silahkan masuk terlebih dahulu yah</p>
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <button class="btn btn-danger btn-block" tabindex="4">Masuk</button>
                                </form>
                                <p class="text-center mt-2"><span>Belum punya akun?</span><a href="{{ route('register') }}" class="text-danger"><span>&nbsp;Daftar di sini</span></a></p>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
